			...
			<div>
				<section className="hero clearfix">
					<div className="contain">
						<span className="label green">v1.2.61</span>
						<h1>Blossom UI</h1>
						...
						<div className="button-group breakpoint-xs-stackable">
							...
							<a rel="noopener noreferrer" target="_blank" className="button medium primary labeled" href="http://d1fb9glqs1l0dr.cloudfront.net/blossom-1.2.61.zip"><i className="fa fa-arrow-down"/> Download Blossom bundle</a>
						</div>
					</div>
				</section>
