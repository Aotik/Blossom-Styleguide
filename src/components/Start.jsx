				...
				<div className="dent-cover">
					<div className="contain">
						...
						<div className="button-group breakpoint-xs-stackable">
							...
							<a rel="noopener noreferrer" target="_blank" href="https://cdn.darken.io/blossom/1.3.0/blossom-1.3.0.zip" className="button medium primary labeled"><i className="fa fa-arrow-down"/> Download Blossom.zip</a>
						</div>
					</div>
				</div>
							...
							<div className="stage">
								<div className="content">
									<div className="header">Installing Blossom via static .zip</div>
										If you are using Blossom UI just as a dependancy, you can download the <a rel="noopener noreferrer" target="_blank" href="https://cdn.darken.io/blossom/1.3.0/blossom-1.3.0.zip">zip</a> and just include it anywhere you need it.
