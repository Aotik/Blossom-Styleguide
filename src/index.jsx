import 'style!./../Blossom/source/blossom.styl';
...
<Router history={browserHistory} onUpdate={initUpdate}>
  <Route path="/" component={Controller} home />
  <Route path="/introduction" component={Controller} start />
  <Route path="/customization" component={Controller} customization />
  <Route path="/changelog" component={Controller} changelog />
  <Route path="elements" component={Controller} resource>
  ...
  <Route path="design" component={Controller} resource>
  ...
  <Route path="utility" component={Controller} resource>
    <IndexRedirect to="js" />
